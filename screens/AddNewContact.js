...
export default class AddNewContact extends Component {
  ...
  constructor(props){
    super(props);
    this.state = {
      fname : "",lname : "",email : "",address : "",image : "empty",
      imageDownloadUrl : "empty",isUploading : false
    }
  }
    ...
    if(this.state.fname !== "" && 
       ...
       this.state.address !== ""
        ...
        if(this.state.image !== "empty"){
          const imageDownloadUrl = await this.uploadImageAsync(this.state.image,storageRef)
          console.log(imageDownloadUrl)
          console.log("is obtained from function")
          this.setState({ imageDownloadUrl : imageDownloadUrl })
        }else{
          console.log("no image this time")
        }
